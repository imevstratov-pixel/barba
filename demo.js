...
(() => {
  ...
  const TABS = [
    ...
    ['tr', 'Перевод', 'i-lang'], ['claude', 'Claude', 'i-spark'], ['tg', 'Telegram', 'i-plane'], ['music', 'Музыка', 'i-note']
  ];
  ...
  function create(host, opts = {}) {
    ...
    const VIEWS = { tasks: vTasks, time: vTime, cal: vCal, tr: vTr, claude: vClaude, tg: vTg, music: vMusic };
