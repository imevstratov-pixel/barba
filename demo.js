...
(() => {
  ...
  const TABS = [
    ...
    ['tr', 'Перевод', 'i-lang'], ['claude', 'Claude', 'i-spark'], ['gpt', 'ChatGPT', 'i-chats'], ['tg', 'Telegram', 'i-plane'],
    ['music', 'Музыка', 'i-note']
  ];
  ...
  function create(host, opts = {}) {
    ...
    function vGpt() {
      ...
      return `<label class="d-field">${ICON('i-chats')}<input class="d-input" data-in="gpt" placeholder="Спросить ChatGPT…" autocomplete="off" aria-label="Вопрос для ChatGPT"></label>
